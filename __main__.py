...
def setup_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--java-home', type=str, default='/home/hanrui/library/jdk', help='java home path')
    parser.add_argument('--hadoop-home', type=str, default='/home/hanrui/library/hadoop', help='Hadoop home path')
    parser.add_argument('--spark-home', type=str, default='/home/hanrui/library/spark', help='Spark home path')
    parser.add_argument('--resource-manager-host', type=str, default='http://10.1.114.50:8088/', help='Address:port of ResourceManager')
    parser.add_argument('--spark-history-server-host', type=str, default='http://10.1.114.50:18080/', help='Address:port of Spark history server')
    ...
    parser.add_argument('--target-update', type=int, default=int(288), metavar='τ', help='Number of steps after which to update target network')
